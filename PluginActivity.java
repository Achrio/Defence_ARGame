...
public class PluginActivity extends UnityPlayerActivity {
    ...
    public void Read() {
        ...
        try {
            ...
            //기사 처리
            if(Code.equals("20")) { //기사 종류
                UnityPlayer.UnitySendMessage("UnityActivity", "SaveSender", Username);
                UnityPlayer.UnitySendMessage("UnityActivity", "KnightType", Data);
            }
            if(Code.equals("21")) { //기사 x
                UnityPlayer.UnitySendMessage("UnityActivity", "SaveSender", Username);
                UnityPlayer.UnitySendMessage("UnityActivity", "KnightX", Data);
            }
            if(Code.equals("22")) { //y
                UnityPlayer.UnitySendMessage("UnityActivity", "SaveSender", Username);
                UnityPlayer.UnitySendMessage("UnityActivity", "KnightY", Data);
            }
            if(Code.equals("23")) { //z
                UnityPlayer.UnitySendMessage("UnityActivity", "SaveSender", Username);
                UnityPlayer.UnitySendMessage("UnityActivity", "KnightZ", Data);
            }
            if(Code.equals("24")) { //레벨
                UnityPlayer.UnitySendMessage("UnityActivity", "SaveSender", Username);
                UnityPlayer.UnitySendMessage("UnityActivity", "KnightLevel", Data);
                UnityPlayer.UnitySendMessage("UnityActivity", "SummonKnight", Data);
            }
